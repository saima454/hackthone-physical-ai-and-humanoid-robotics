...
const config: Config = {
  ...
  customFields: {
    apiUrl: process.env.REACT_APP_API_URL || 'web-production-0500d.up.railway.app',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/saima454',
        },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/saima454',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'saima454 GitHub',
              href: 'https://github.com/saima454',
            },
            {
              label: 'LinkedIn',
              href: 'https://www.linkedin.com/in/saima-bukhsh-97b0412bb/',
            },
          ],
        },
        {
